...
class CommentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['content'].widget.attrs['placeholder'] = 'Dinos que piensas'
        self.fields['email'].widget.attrs['placeholder'] = 'Correo'
        self.fields['name'].widget.attrs['placeholder'] = 'Nombres'
...
class SubscribeForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['email'].widget.attrs['placeholder'] = 'Escribe tu gmail'
